...
Use this to register a new resource (for example, `orders`, `invoices`, or any domain resource) that actions/scopes can
be attached to.
...
- `N3XT0R\LaravelPassportAuthorizationCore\Events\PassportScopeResource\ResourceCreatedEvent` is dispatched after
  creation.
